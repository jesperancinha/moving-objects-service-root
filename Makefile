...
build-npm-docker:
	...
	docker run --name moving-objects-gui-build -v moving-objects-gui/dist:moving-objects-gui/dist moving-objects-gui-image -c 'cd moving-objects-gui && npm run build'
wrapper:
	gradle wrapper
build-app:
