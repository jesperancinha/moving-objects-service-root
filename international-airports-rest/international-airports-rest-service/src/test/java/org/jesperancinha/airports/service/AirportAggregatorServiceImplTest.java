...
import org.jesperancinha.airports.repository.AirportRepositoryImpl;
import org.jesperancinha.airports.repository.WebCamRepositoryImpl;
...
public class AirportAggregatorServiceImplTest {
    ...
    @Autowired
    private AirportAggregatorService airportAggregatorService;
    ...
    public static void beforeAll() throws IOException {
        ...
        stubFor(get(urlEqualTo("/international/airports/live/airports/code/AMS"))
                .willReturn(aResponse()
                        .withBody(IOUtils.toString(AirportAggregatorServiceImplTest.class.getResourceAsStream("/airport-response-AMS.json")))
                        .withHeader("Content-Type", "application/json")
                ));
        stubFor(get(urlEqualTo("/international/airports/live/webcams/location/52.308056/4.764167/10"))
                .willReturn(aResponse()
                        .withBody(IOUtils.toString(AirportAggregatorServiceImplTest.class.getResourceAsStream("/webcams-response-AMS-10.json")))
                        .withHeader("Content-Type", "application/json")
                ));
        BlockHound.install();
    ...
    public void testGetAirportByCode_whenCode_Get10Cameras() {
        ...
        final Flux<AirportDto> airportByCode = airportAggregatorService.getAirportByCode(testCode, testRadius);
    ...
    public void testGetAirportByCode_whenMonoCode_Get1Camera() {
        ...
        final Mono<AirportDto> airportByCode = Mono.from(airportAggregatorService.getAirportByCode(testCode, testRadius));
